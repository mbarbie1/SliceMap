...
import static be.ua.mbarbier.slicemap.lib.roi.LibRoi.transformRoi;
import static be.ua.mbarbier.slicemap.lib.roi.LibRoi.transformRoiInverse;
import static be.ua.mbarbier.slicemap.lib.transform.Transform2D.applyRoiInverseTransform;
import static be.ua.mbarbier.slicemap.lib.transform.Transform2D.applyRoiTransform;
