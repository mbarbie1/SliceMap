...
import static be.ua.mbarbier.external.Transform_Roi.fitGlobalAffine;
...
import static be.ua.mbarbier.slicemap.lib.transform.Transform2D.removeAffineScalingMagnitude;
import ij.IJ;
import ij.ImagePlus;
