...
import be.ua.mbarbier.slicemap.lib.registration.LibRegistration;
import static be.ua.mbarbier.slicemap.lib.registration.LibRegistration.siftSingle;
import be.ua.mbarbier.slicemap.lib.roi.LibRoi;
import static be.ua.mbarbier.slicemap.lib.roi.LibRoi.getOverlayImage;
import static be.ua.mbarbier.slicemap.lib.roi.LibRoi.getOverlayImageRGB;
import be.ua.mbarbier.slicemap.lib.transform.ElasticTransform2D;
import static be.ua.mbarbier.slicemap.lib.transform.Transform2D.applyInverseTransform;
