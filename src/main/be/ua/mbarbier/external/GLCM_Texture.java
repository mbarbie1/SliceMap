...
public class GLCM_Texture implements PlugInFilter {
	...
	// TODO Michael Barbier adaptation 
	public final static String stepDirection0 = "0 degrees";
	public final static String stepDirection90 = "90 degrees";
	public final static String stepDirection180 = "180 degrees";
	public final static String stepDirection270 = "270 degrees";
	public double asm = 0.0;
	public double contrast = 0.0;
	public double correlation = 0.0;
	public double entropy = 0.0;
	public double suma = 0.0;
	public double IDM = 0.0;
	 ...
	 * @param stepPixels	Stepsize in pixels
	 * @param direction		Direction of the steps
	 */
	public void compute( ImageProcessor ip, int stepPixels, String direction ) {
		...
		if (doIcalculateASM==true){
			...
			for (a=0;  a<257; a++)  {
				for (b=0; b<257;b++) {
					this.asm=this.asm+ (glcm[a][b]*glcm[a][b]);
				}
			}
		}
		...
		if (doIcalculateContrast==true){
			...
			for (a=0;  a<257; a++)  {
				for (b=0; b<257;b++) {
					this.contrast=this.contrast+ (a-b)*(a-b)*(glcm[a][b]);
				}
			}
		}
		...
		if (doIcalculateCorrelation==true){
			...
			for (a=0;  a<257; a++)  {
				for (b=0; b<257;b++) {
					this.correlation = this.correlation+( (a-px)*(b-py)*glcm [a][b]/(stdevx*stdevy)) ;
				}
			}
		}
		//===============================================================================================
		...
		if (doIcalculateIDM==true){
			...
			for (a=0;  a<257; a++)  {
				for (b=0; b<257;b++) {
					this.IDM=this.IDM+ (glcm[a][b]/(1+(a-b)*(a-b)))  ;
				}
			}
			...
			for (a=0;  a<257; a++)  {
				for (b=0; b<257;b++) {
					if (glcm[a][b]==0) {}
						...
						this.entropy = entropy-(glcm[a][b]*(Math.log(glcm[a][b])));
					}
				}
			}
