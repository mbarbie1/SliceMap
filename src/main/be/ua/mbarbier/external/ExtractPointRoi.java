 ...
 * 
 * This is meant to extend the SIFT plugin of Stefan Saalfeld to more image 
 * features/descriptors such as ORB, BRISK, FREAK, KAZE, A-KAZE, HARRIS, FAST, 
 * SUSAN ... Therefore features/descriptors can be obtained through Catalano 
 * frame-work or opencv.
 * 
 * 
 ...
 * @version 0.4b
 */
public class ExtractPointRoi implements PlugIn
{
	...
	List< String > descriptorMethods = new ArrayList<>();
	private int descriptorMethod;
	...
	public void run( final String args )
	{
		...
		final GenericDialog gd = new GenericDialog( "Extract Landmark Correspondences" );
		
		gd.addMessage( "Image Selection:" );
		final String current = WindowManager.getCurrentImage().getTitle();
		gd.addChoice( "Descriptor type", descriptorMethods.toArray(new String[]{""}), descriptorMethods.get(0) );
		...
		this.descriptorMethod = gd.getNextChoiceIndex();
